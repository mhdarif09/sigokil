            ...
            <div class="ml-4 flex items-center md:ml-6">
              ...
              <div class="relative ml-3">
                ...
                x-transition:leave-end="opacity-0 scale-95"
                  ...
                  <a href="cart" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-0">keranjang</a>
        ...
        <div class="container mx-auto px-4 py-6">
            <div class="bg-white shadow-md rounded p-6">
                ...
                <div class="flex justify-center mb-6">
                    <img src="{{ asset('images/qris.jpeg') }}" alt="QRIS Logo" class="w-32 h-auto">
                </div>
    
                <p class="text-lg font-semibold">Order ID: <span class="font-normal">{{ $order->id }}</span></p>
                <p class="mt-4 text-lg font-semibold">Subtotal: <span class="font-normal">Rp. {{ number_format($subtotal, 2) }}</span></p>
                <p class="mt-2 text-lg font-semibold">Total: <span class="font-normal">Rp. {{ number_format($total, 2) }}</span></p>
            </div>
    
            <!-- Payment status buttons -->
            <div class="mt-6 flex justify-start">
                <a href="{{ route('qris.accept', $order->id) }}" class="bg-green-500 text-white py-2 px-4 rounded hover:bg-green-600 transition duration-300">Accept Payment</a>
                <a href="{{ route('qris.reject', $order->id) }}" class="bg-red-500 text-white py-2 px-4 rounded ml-4 hover:bg-red-600 transition duration-300">Reject Payment</a>
            </div>
        </div>
        </div>
      </div>
