...
<body class="bg-gray-100">
    <div id="app">
        ...
        <div class="min-h-screen flex items-center justify-center bg-cover bg-center" style="background-image: url('{{ asset('images/background.png') }}'); background-color: rgba(0, 0, 0, 0.5); background-blend-mode: overlay;">
            <div class="max-w-4xl w-full bg-white bg-opacity-90 shadow-md rounded-lg p-8 space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <!-- Card untuk UMKM -->
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        <h2 class="text-2xl font-bold text-center text-gray-900">Log in UMKM</h2>
                    ...
                    <!-- Card untuk Customer -->
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        <h2 class="text-2xl font-bold text-center text-gray-900">Log in Customer</h2>
                        <form method="POST" action="{{ route('login') }}">
                            @csrf
                            <div>
                                <label for="email" class="block text-sm font-medium text-gray-700">Email Address</label>
