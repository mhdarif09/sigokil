            ...
            <div class="container mx-auto p-4 flex justify-between items-center">
                ...
                <nav class="flex justify-between items-center">
                    ...
                    <div class="flex space-x-3 relative" x-data="{ dropdownOpen: false }">
                        @if (Route::has('login'))
                            @auth('admin')
                                <a href="{{ route('admin.transactions') }}" class="px-3 flex items-center">
                                    <i class="fas fa-tachometer-alt mr-1"></i> Dashboard
                                </a>
                                <div class="relative">
                                    <button @click="dropdownOpen = !dropdownOpen"
                                            class="px-3 flex items-center focus:outline-none">
                                        <i class="fas fa-user mr-1"></i> Admin Account
                                    </button>
                            ...
                            @else
                                <a href="{{ route('admin.login') }}" class="px-3 flex items-center">
